    ...
    <>
      {draw ? (
        <motion.div
          ...
          className="min-h-96 hover: relative border-8 border-yellow-500 min-w-64 bg-gradient-to-r from-pink-200 to-green-200 flex flex-col items-center justify-center max-w-64 rounded-3xl shadow-xl shadow-black  bg-slate-200"
        >
